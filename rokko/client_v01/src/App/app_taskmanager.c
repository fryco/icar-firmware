...
unsigned char BUILD_REV[] __attribute__ ((section ("FW_REV"))) ="$Rev: 102 $";//Don't modify this line
...
void console_cmd( unsigned char cmd, unsigned char *flag, unsigned char *flash_idx )
{
	...
	case 'v' ://show revision
		show_sys_info( );
		prompt("$URL: svn://svn.cn0086.info/icar/firmware/APP_HW_v01/src/App/app_taskmanager.c $\r\n");
		prompt("$Id: app_taskmanager.c 102 2013-02-16 09:55:12Z cn0086.info $\r\n");
		break;

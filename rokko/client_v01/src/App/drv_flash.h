/**
  ...
  * @file    $URL: svn://svn.cn0086.info/icar/firmware/APP_HW_v01/src/App/drv_flash.h $ 
  * @version $Rev: 73 $
...
typedef enum
{
	NO_UPGRADE = 0, //no need upgrade
	UPGRADING  = 1, //upgrading ...
	UPGRADED   = 2  //download firmware complete, wait reboot
} UPGRADE_STATUS;
...
//CRC read as: *(vu32*) ==> *(vu16*), 2013/1/2 11:09:50

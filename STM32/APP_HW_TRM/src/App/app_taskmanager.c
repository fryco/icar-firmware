...
unsigned char BUILD_REV[] __attribute__ ((section ("FW_REV"))) ="$Rev: 218 $";//Don't modify this line
...
void console_cmd( unsigned char cmd, unsigned char *flag )
{
	...
	case 'v' ://show revision
		...
		prompt("$Id: app_taskmanager.c 271 2012-09-07 01:19:16Z cn0086.info@gmail.com $\r\n");
		break;
